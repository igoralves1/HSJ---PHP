...
INSERT INTO exams (exams,hexrgbcode) VALUES 
('CT-SCAN (TOMODENSITOMÉTRIE)','#402e22');
('IRM (IMAGERIE PAR RÉSONNANCE MAGNÉTIQUE)','#402e22'),
('MÉDECINE NUCLÉAIRE','#402e22'),
('RADIOLOGIE','#402e22'),
('SALLE D\'ANGIOGRAPHIE','#402e22'),
('SALLE D\'OPÉRATION','#3d7252'),
('SALLE DE CATHÉTÉRISME CARDIAQUE','#192f22');
